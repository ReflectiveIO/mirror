...
pub struct ExtMotionTriangleMesh;

impl Mesh for ExtMotionTriangleMesh {
    fn get_type(&self) -> MeshType { MeshType::ExtTriangleMotion }
...
impl ExtMesh for ExtMotionTriangleMesh {
